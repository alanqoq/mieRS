...
version = providers.gradleProperty("pluginVersion").orElse("0.0.10").get()
...
dependencies {
    compileOnly("com.mieai.qqbot:qqbot-plugin-api:1.0.9")
    compileOnly("com.mieai.qqbot:qqbot-plugin-spi:1.0.9")
    embeddedLibraries("com.google.code.gson:gson:2.13.1")
    embeddedLibraries("org.yaml:snakeyaml:2.2")
    testImplementation(kotlin("test-junit5"))
    testImplementation("com.mieai.qqbot:qqbot-plugin-testkit:1.0.9")
